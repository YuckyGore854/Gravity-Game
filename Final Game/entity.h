...
public:
	...
	void loadSprites(const char* filename, SDL_Renderer* renderer);//loads the image you pass it, second parameter is for keeping the alpha(transparency) of an image
};
